...
vim.api.nvim_create_augroup('python_rulers', { clear = true })
...
require('lazy').setup({
  ...
  'github/copilot.vim',
  {
    ...
    config = function()
      ...
      -- You can also define keymaps here
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      -- command to close highlighted buffer
      ...
      -- commands to go to navigate buffers
